...
\begin{tcolorbox}[
  ...
  \begin{tikzpicture}[x=0.15cm, y=0.15cm]
    \foreach \x [count=\xi from 0] in {0,...,6} {
      \foreach \y [count=\yi from 0] in {0,...,11} {
        \pgfmathsetmacro{\intensity}{2,3,2,4,4,2,4,4,4,2,3,0,1,3,4,2,3,1,2,3,1,4,4,0,1,0,0,1,2,4,2,1,2,2,3,0,3,2,1,0,1,4,1,0,2,1,1,0,1,2,2,4,3,4,3,2,4,4,0,0,1,4,0,1,4,2,1,3,1,1,2,0,2,0,0,1,2,3,3,0,1,4,2,4[\xi*12+\yi]}
        \definecolor{cellcolor}{RGB}{
          \ifnum\intensity=0 238,238,238
          \else\ifnum\intensity=1 155,233,168
          \else\ifnum\intensity=2 64,196,99
          \else\ifnum\intensity=3 48,161,78
          \else 33,110,57\fi\fi\fi\fi
        }
        \fill[cellcolor] (\x*1.1, -\y*1.1) rectangle +(1,1);
      }
    }
...
\begin{tcolorbox}[
  ...
  boxrule=0.5pt
    ...
    \begin{tcolorbox}[
      ...
      \vspace{2mm}
      \begin{flushright}
        \textcolor{githubGray}{\scriptsize\faCodeFork\ 1 \hspace{2mm}\faEye\ 66}
      \end{flushright}
    \end{tcolorbox}
...
\vspace{2mm}
    ...
    \begin{tcolorbox}[
      ...
      \vspace{2mm}
      \begin{flushright}
        \textcolor{githubGray}{\scriptsize\faCodeFork\ 1 \hspace{2mm}\faEye\ 68}
      \end{flushright}
    \end{tcolorbox}
...
\vspace{2mm}
    ...
    \begin{tcolorbox}[
      ...
      \vspace{2mm}
      \begin{flushright}
        \textcolor{githubGray}{\scriptsize\faCodeFork\ 1 \hspace{2mm}\faEye\ 85}
      \end{flushright}
    \end{tcolorbox}
...
\vspace{2mm}
    ...
    \begin{tcolorbox}[
      ...
      \vspace{2mm}
      \begin{flushright}
        \textcolor{githubGray}{\scriptsize\faCodeFork\ 1 \hspace{2mm}\faEye\ 83}
      \end{flushright}
    \end{tcolorbox}
...
\vspace{2mm}
    ...
    \begin{tcolorbox}[
      ...
      \vspace{2mm}
      \begin{flushright}
        \textcolor{githubGray}{\scriptsize\faCodeFork\ 1 \hspace{2mm}\faEye\ 29}
      \end{flushright}
    \end{tcolorbox}
