  ...
  \begin{tikzpicture}[x=0.15cm, y=0.15cm]
    \foreach \x [count=\xi from 0] in {0,...,6} {
      \foreach \y [count=\yi from 0] in {0,...,11} {
        \pgfmathsetmacro{\intensity}{4,1,2,1,0,2,2,1,2,2,1,2,3,1,3,2,0,1,2,4,4,3,0,3,4,1,2,2,3,0,1,2,0,0,3,0,4,1,2,2,1,3,2,3,4,2,2,4,0,1,4,1,3,1,4,0,2,1,1,2,2,0,4,4,0,1,3,3,1,0,1,3,4,3,3,1,1,3,2,2,0,0,0,3.split(',')[\xi*12+\yi]}
...
\begin{tcolorbox}[
  ...
  boxrule=0.5pt
    ...
    \begin{tcolorbox}[
      ...
      \vspace{2mm}
      \begin{flushright}
        \textcolor{githubGray}{\scriptsize\faCodeFork\ 1 \hspace{2mm}\faEye\ 39}
      \end{flushright}
    \end{tcolorbox}
...
\vspace{2mm}
    ...
    \begin{tcolorbox}[
      ...
      \vspace{2mm}
      \begin{flushright}
        \textcolor{githubGray}{\scriptsize\faCodeFork\ 1 \hspace{2mm}\faEye\ 31}
      \end{flushright}
    \end{tcolorbox}
...
\vspace{2mm}
    ...
    \begin{tcolorbox}[
      ...
      \vspace{2mm}
      \begin{flushright}
        \textcolor{githubGray}{\scriptsize\faCodeFork\ 1 \hspace{2mm}\faEye\ 17}
      \end{flushright}
    \end{tcolorbox}
...
\vspace{2mm}
    ...
    \begin{tcolorbox}[
      ...
      \vspace{2mm}
      \begin{flushright}
        \textcolor{githubGray}{\scriptsize\faCodeFork\ 1 \hspace{2mm}\faEye\ 60}
      \end{flushright}
    \end{tcolorbox}
